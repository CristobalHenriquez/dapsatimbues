...
<section id="contacto" class="hotel-contact">
    <div class="container">
        ...
        <div class="contact-wrapper">
            ...
            <form class="contact-form" action="controladores/procesar-contacto.php" method="post" id="contactFormHotel">
...
<script>
    document.getElementById('contactFormHotel').addEventListener('submit', function(e) {
        e.preventDefault();
